...
'''
class RestaurantCompleteForm(forms.ModelForm):

    class Meta:
        model = base_models.Restaurant
        fields = ('name', 'description', 'price_range', 'dress_code',
                  'cuisine', 'payment_options', 'menu', 'operating_hours',

                  'area', 'address', 'longitude', 'latitude',

                  'contact_info', 'parking_info',  'additional_info', 'website')
        ...
        self.helper.layout = Layout(
            TabHolder(
                ...
                Tab('Additional Information',
                    Fieldset('',
                             'contact_info', 'parking_info',
                             'additional_info', 'website'
                             )
                    )
            ),
            Submit('submit', 'Submit',
                   css_class='btn btn-lg btn-primary inline-block pull-right'),
            Button('cancel', 'Cancel', css_class="btn btn-lg btn-default inline-block",
